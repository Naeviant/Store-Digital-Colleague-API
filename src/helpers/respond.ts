...
type Payload = string | null | IAssignment | IAssignment[] | IAisle | IAisle[] | IBay | IBay[] | ICustomer | IModule | IModule[] | IModuleInstance | IModuleInstance[] | IProduct | IProduct[] | IProductQuantity | ISite | ISite[] | IUser;
